...
{
    public class DefaultCookies : IDictionary<string, string>
    {
        public Microsoft.AspNetCore.Http.HttpContext httpContext { get; }

        public DefaultCookies(IHttpContextAccessor accessor)
        {
    ...
    {
        private DefaultCookies cookies;

        private int position = -1;

        public CookiesEnumerator(DefaultCookies cookies)
        {
