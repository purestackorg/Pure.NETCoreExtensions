...
namespace Pure.NetCoreExtensions.RateLimit
{
    public class ClientRateLimitMiddleware
    {
        ...
        public virtual ClientRequestIdentity SetIdentity(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            var clientId = "anon";
        ...
        public virtual Task ReturnQuotaExceededResponse(Microsoft.AspNetCore.Http.HttpContext httpContext, RateLimitRule rule, string retryAfter)
        {
        ...
        public virtual void LogBlockedRequest(Microsoft.AspNetCore.Http.HttpContext httpContext, ClientRequestIdentity identity, RateLimitCounter counter, RateLimitRule rule)
        {
